<?php
    include("bd.php");
    $paginadeProfesional="https://hurtadorealty.com/professional";
    $paginadeExperience="https://hurtadorealty.com/experience";
    $paginadeOnBoarding="https://hurtadorealty.com/onboarding";
    $paginadeGracias="https://oasisinmobiliario.com/pago-hurtado-realty/";
    $valorNulo=NULL;
    ...
    {       
        ...
        if($cuentaYaExiste=="0")
        {
                    ...
                    if (isset($resultado["id"]))
                    {
                        ...
                        $resultado=$sentenciaSQL->fetch(PDO::FETCH_LAZY); 
                        if (isset($resultado["personas_id"]))
                        {
                        ...
                        agente_id, referido_por_id, status_id , idioma_id, perfil_id) 
                        values (:personas_id, :nombre, :apellido, :fecha_nacimiento,
                        :telefono1, :nombre_completo, :tipo_persona_id,
                        :fecha_cap, :fecha_act, :idioma, :persona_act_id, :correo, :user_login, :referido_por,:comision,
                        :agente_id, :referido_por_id,:status_id, (select  id from tb_idiomas where descripcion=:idioma2), :perfil_id
                         )" ;
                        $sentenciaSQL=$conexion->prepare($sql);
                        ...
                        if ($inputPlanId=="1") {header("Location: $paginadeProfesional");};
                        if ($inputPlanId=="6") {header("Location: $paginadeExperience");}
                        if ($inputPlanId=="10") {header("Location: $paginadeOnBoarding");}                      
...
<html lang="en">
    <head>
        ...
        <title>Registro de Agentes - Oasis Inmobiliario</title>
                                                ...
                                                <div class="col-md-6">                                                                                                
                                                    <div class="form-floating mb-3 mb-md-0">                                                   
                                                                ...
                                                                <div  class="btn-group" role="group" aria-label="Basic checkbox toggle button group">                                                            
                                                                    <input value="1" type="radio" class="btn-check" checked name="btnradio2" id="btncheck4" autocomplete="off">
                                                                    <label class="btn btn-outline-primary" for="btncheck4">Profesional</label>

                                                                    <input value="6" type="radio" class="btn-check" name="btnradio2" id="btncheck5" autocomplete="off">
                                                                    <label class="btn btn-outline-primary" for="btncheck5">Experience</label>

                                                                    <input value="10" type="radio" class="btn-check" name="btnradio2" id="btncheck6" autocomplete="off">
                                                                    <label class="btn btn-outline-primary" for="btncheck6">Onboarding</label>
                                                                </div>                                                        
                                                    </div>        
                                                </div>    
                                                <div class="col-md-7">
